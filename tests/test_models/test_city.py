...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        cityString = city.__str__()
        self.assertIn("[City] (123456)", cityString)
        self.assertIn("'id': '123456'", cityString)
        self.assertIn("'created_at': " + dateRepresentation, cityString)
        self.assertIn("'updated_at': " + dateRepresentation, cityString)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        city = City(id="345", created_at=date_isoFormat, updated_at=date_isoFormat)
