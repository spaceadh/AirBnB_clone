...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        placeString = place.__str__()
        self.assertIn("[Place] (123456)", placeString)
        self.assertIn("'id': '123456'", placeString)
        self.assertIn("'created_at': " + dateRepresentation, placeString)
        self.assertIn("'updated_at': " + dateRepresentation, placeString)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        place = Place(id="345", created_at=dateIsoFormat, updated_at=dateIsoFormat)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        ...
        self.assertEqual(str, type(placedict["id"]))
        self.assertEqual(str, type(placedict["created_at"]))
        self.assertEqual(str, type(placedict["updated_at"]))
