...
class Test_Place_instantiation(u.TestCase):
    """
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        pl = Place(id="246", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(pl.id, "246")
...
class Test_Place_save(u.TestCase):
    """
...
class Test_Place_to_dict(u.TestCase):
    """
    ...
    def test_to_dict_contains_added_attributes(self):
        pl = Place()
        pl.middle_name = "Wachira"
        pl.my_number = 33
        self.assertEqual("Wachira", pl.middle_name)
